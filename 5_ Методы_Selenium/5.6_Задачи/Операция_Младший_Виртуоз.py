'''
Информация, которая вам доступна, позволяет нам сделать вывод: вам необходимо найти и завербовать младшего и наиболее
перспективного хакера из противоборствующей группы. Этот человек уникален — он знает больше всего языков
программирования среди своих соратников. После того, как вы его обнаружите, вам нужно извлечь "value" из его cookie
и вставить это значение в поле для ответов на степик.
Этапы миссии:
Переход на сайт: Используйте Selenium для того, чтобы перейти на целевой веб-сайт 'https://parsinger.ru/selenium/5.6/1/index.html'.
